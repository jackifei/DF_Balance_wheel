...
void handleCommand() {
  ...
  Serial.print("HTTP CMD: "); Serial.println(DATA);

  // ========== 原 switch 逻辑移植 ==========
  switch (DATA) {
    /*---机械平衡角度调整-----*/
    case 'u': Keep_Angle += 0.01; break;
    case 'd': Keep_Angle -= 0.01; break;

    /*----直立平衡PID调整-----*/
    case '0': kp -= 0.1; break;
    case '1': kp += 0.1; break;
    case '2': ki -= 0.01; break;
    case '3': ki += 0.01; break;
    case '4': kd -= 0.01; break;
    case '5': kd += 0.01; break;
    case '6': turn_kp -= 0.01; break;
    case '7': turn_kp += 0.01; break;
